...
//@Disabled
@Autonomous(name = "RedLeft_BlueRight_Auto2", group = "VECTOR_AUTO")

public class RedLeft_BlueRight extends LinearOpMode {
    ...
    static final Pose2D TARGET_1 = new Pose2D(DistanceUnit.MM, -707, 0, AngleUnit.DEGREES, 0);
    ...
    public void LowerLift() {
        robotBase.ExtendPincher();
        runLiftsToPos(liftsLowPos);
        waitLifts(2000);
        //robotBase.ExtendPincher();
        robotBase.OpenPincher();
        robotBase.RetractPincher();
